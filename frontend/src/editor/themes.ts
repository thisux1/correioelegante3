...
import { createPersonaTheme, isPersonaThemeId, parsePersonaThemeId } from '@/editor/utils/colorHarmonizer'
...
export const themeCatalog: Theme[] = [
  {
    ...
    variables: {
      ...
      fontCursive: '"Dancing Script", "Brush Script MT", "Segoe Script", cursive',
      surface: '#fff8f9',
  ...
  },
  {
    ...
    variables: {
      ...
      font: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
      fontDisplay: '"Playfair Display", Georgia, "Times New Roman", serif',
      fontCursive: '"Great Vibes", "Brush Script MT", "Segoe Script", cursive',
      surface: '#111827',
      surfaceGlass: 'rgba(17, 24, 39, 0.92)',
      border: '#374151',
      textLight: '#94a3b8',
    },
  },
  {
    ...
    variables: {
      ...
      text: '#451a03',
      accent: '#b45309',
      font: '"EB Garamond", "Libre Baskerville", Georgia, "Times New Roman", serif',
      fontDisplay: '"Playfair Display", Georgia, "Times New Roman", serif',
  ...
  },
  {
    ...
    variables: {
      ...
      fontDisplay: '"Playfair Display", Georgia, "Times New Roman", serif',
      fontCursive: '"Caveat", "Segoe Print", "Brush Script MT", cursive',
      surface: '#18181b',
      surfaceGlass: 'rgba(17, 24, 39, 0.92)',
      border: '#4b5563',
      textLight: '#cbd5e1',
  ...
  },
  {
    ...
    variables: {
      ...
      accent: '#2dd4bf',
      font: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
      fontDisplay: '"Merriweather", Georgia, "Times New Roman", serif',
      fontCursive: '"Caveat", "Segoe Print", "Brush Script MT", cursive',
      surface: '#f3ffff',
  ...
  },
  {
    ...
    variables: {
      ...
      text: '#3f2a18',
      accent: '#e6b86a',
      font: '"EB Garamond", "Playfair Display", Georgia, "Times New Roman", serif',
      fontDisplay: '"Playfair Display", Georgia, "Times New Roman", serif',
      fontCursive: '"Great Vibes", "Brush Script MT", "Segoe Script", cursive',
      surface: '#fffaf0',
  ...
  },
  {
    ...
    variables: {
      ...
      accent: '#7bbf97',
      font: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
      fontDisplay: '"EB Garamond", "Libre Baskerville", Georgia, serif',
      fontCursive: '"Satisfy", "Brush Script MT", cursive',
      surface: '#f5fcf7',
...
function findThemeById(themeId?: string | null): Theme | undefined {
  ...
  if (isPersonaThemeId(themeId)) {
    const parsed = parsePersonaThemeId(themeId)
    if (parsed) {
      return createPersonaTheme(parsed.primary, parsed.mood, { secondaryColor: parsed.secondary })
    }
  }

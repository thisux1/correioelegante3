...
export const EDITOR_FIELD_BASE_CLASS = 'w-full min-h-11 rounded-xl border border-border bg-surface text-text px-3 py-2 text-sm outline-none transition-colors placeholder:text-text-light/50 focus:border-primary/50 focus-visible:ring-2 focus-visible:ring-primary/30'
      ...
      <AnimatePresence initial={false}>
        {stateText ? (
          <motion.p
            ...
            className={`inline-flex items-center gap-1.5 text-xs ${state === 'error' ? 'text-red-500' : state === 'success' ? 'text-emerald-500' : 'text-text-light'}`}
